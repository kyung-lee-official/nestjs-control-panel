import { Controller, Get, Post, Body, Param, Delete, Ip, UseGuards } from '@nestjs/common';
...
export class ChituboxManualFeedbacksController {
	...
	@Get()
	find(@Body() findChituboxManualFeedbackDto: FindChituboxManualFeedbackDto): Promise<ChituboxManualFeedback[]> {
		return this.chituboxManualFeedbacksService.find(findChituboxManualFeedbackDto);
	}
